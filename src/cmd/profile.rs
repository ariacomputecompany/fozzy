...
#[path = "profile/analysis.rs"]
mod analysis;
#[path = "profile/build.rs"]
mod build;
#[path = "profile/dispatch.rs"]
mod dispatch;
#[path = "profile/render.rs"]
mod render;
...
use render::{folded_to_speedscope, folded_to_svg, folded_to_text, heap_folded, timeline_html};
use support::{
...
pub use build::heap_budget_findings_from_trace;
...
pub fn profile_command(
    ...
    dispatch::dispatch_profile_command(config, command, strict)
}
