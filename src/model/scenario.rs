...
pub const DISTRIBUTED_STEP_KIND_NAMES: &[&str] = &[
    "client_put",
    "client_get_assert",
    "partition",
    "heal",
...
pub const DISTRIBUTED_INVARIANT_KIND_NAMES: &[&str] =
    &["kv_all_equal", "kv_present_on_all", "kv_node_equals"];
